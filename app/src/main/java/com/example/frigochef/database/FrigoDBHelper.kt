 ...
 * au premier lancement de l'application. La base contient 4 tables :
 * ingredient, recette, recette_ingredient et session_ingredients.
 *
    ...
    private fun seederRecettes(db: SQLiteDatabase) {
        val recettes = listOf(
            ...
            listOf("Houmous", "Trempette crémeuse aux pois chiches",
                ...
                15, "Facile", "Moyen-Orientale", "Collation", 1, 1, 1, 6, "houmous"),
            listOf("Shawarma au poulet", "Poulet mariné aux épices du Moyen-Orient",
                ...
                40, "Moyen", "Moyen-Orientale", "Dîner", 0, 0, 0, 4, "shawarma"),
            listOf("Taboulé", "Salade fraîche au persil et couscous",
                ...
                20, "Facile", "Moyen-Orientale", "Déjeuner", 1, 1, 1, 6, "taboule"),
            ...
            listOf("Ratatouille", "Mijotée de légumes provençaux",
                ...
                60, "Moyen", "Méditerranéenne", "Dîner", 1, 1, 1, 4, "ratatouille"),
            listOf("Salade niçoise", "Salade composée du sud de la France",
                ...
                25, "Facile", "Méditerranéenne", "Déjeuner", 0, 0, 1, 4, "salade_nicoise"),
            listOf("Paella aux légumes", "Riz espagnol coloré aux légumes",
                ...
                45, "Difficile", "Méditerranéenne", "Dîner", 1, 1, 1, 6, "paella_aux_legumes"),
            ...
            listOf("Spaghetti Carbonara", "Pâtes crémeuses à l'italienne",
                ...
                20, "Facile", "Italienne", "Dîner", 0, 0, 0, 4, "spaghetti_carbonara"),
            listOf("Risotto aux champignons", "Risotto crémeux aux champignons",
                ...
                35, "Moyen", "Italienne", "Dîner", 1, 0, 1, 4, "risotto_aux_champignons"),
            listOf("Pâtes à la bolognaise", "Sauce à la viande mijotée",
                ...
                50, "Facile", "Italienne", "Dîner", 0, 0, 0, 4, "pates_a_la_bolognaise"),
            ...
            listOf("Salade grecque", "Salade fraîche à la feta",
                ...
                10, "Facile", "Grecque", "Déjeuner", 1, 0, 1, 4, "salade_grecque"),
            listOf("Moussaka", "Gratin d'aubergines à la grecque",
                ...
                90, "Difficile", "Grecque", "Dîner", 0, 0, 0, 6, "moussaka"),
            listOf("Souvlaki", "Brochettes de poulet marinées",
                ...
                30, "Facile", "Grecque", "Dîner", 0, 0, 0, 4, "souvlaki"),
            ...
            listOf("Burger maison", "Burger juteux au boeuf haché",
                ...
                20, "Facile", "Américaine", "Dîner", 0, 0, 0, 4, "burger_maison"),
            listOf("Mac and Cheese", "Pâtes crémeuses au fromage",
                ...
                25, "Facile", "Américaine", "Dîner", 1, 0, 0, 4, "mac_n_cheese"),
            listOf("Chili con carne", "Ragoût épicé au boeuf",
                ...
                60, "Moyen", "Américaine", "Dîner", 0, 0, 1, 6, "chilli_con_carne"),
            ...
            listOf("Butter Chicken", "Poulet mijoté dans une sauce crémeuse aux épices",
                ...
                45, "Moyen", "Indienne", "Dîner", 0, 0, 1, 4, "butter_chicken"),
            listOf("Dal aux lentilles", "Soupe épicée aux lentilles",
                ...
                35, "Facile", "Indienne", "Dîner", 1, 1, 1, 6, "dal_aux_lentilles"),
            listOf("Saag Paneer", "Épinards crémeux au fromage indien",
                ...
                30, "Moyen", "Indienne", "Dîner", 1, 0, 1, 4, "saag_paneer"),
            ...
            listOf("Mapo Tofu", "Tofu épicé à la sauce soja et piment",
                ...
                25, "Moyen", "Japonaise", "Dîner", 0, 0, 1, 4, "mapo_tofu"),
            listOf("Ramen au poulet", "Soupe de nouilles japonaise",
                ...
                60, "Difficile", "Japonaise", "Dîner", 0, 0, 0, 2, "ramen_au_poulet"),
            listOf("Gyoza", "Raviolis japonais poêlés",
                ...
                40, "Difficile", "Japonaise", "Collation", 0, 0, 0, 4, "gyoza"),
            ...
            listOf("Tacos au boeuf", "Tacos festifs à la mexicaine",
                ...
                25, "Facile", "Mexicaine", "Dîner", 0, 0, 0, 4, "tacos_au_boeuf"),
            listOf("Guacamole", "Trempette fraîche à l'avocat",
                ...
                10, "Facile", "Mexicaine", "Collation", 1, 1, 1, 6, "guacamole"),
            listOf("Enchiladas végétariennes", "Tortillas farcies aux légumes gratinées",
                ...
                40, "Moyen", "Mexicaine", "Dîner", 1, 0, 0, 4, "enchiladas_vegetariennes"),
            ...
            listOf("Poutine", "Frites, fromage en grains et sauce",
                ...
                40, "Facile", "Québécoise", "Dîner", 1, 0, 0, 2, "poutine"),
            listOf("Soupe aux pois", "Soupe traditionnelle québécoise",
                ...
                70, "Facile", "Québécoise", "Déjeuner", 0, 0, 1, 6, "soupe_aux_pois"),
            listOf("Tourtière", "Pâté à la viande traditionnel",
                ...
                90, "Difficile", "Québécoise", "Dîner", 0, 0, 0, 6, "tourtiere"),
            ...
            listOf("Poulet yassa", "Poulet mariné à l'oignon et citron",
                ...
                50, "Moyen", "Africaine", "Dîner", 0, 0, 1, 4, "poulet_yassa"),
            listOf("Tagine d'agneau", "Ragoût épicé à l'agneau et légumes",
                ...
                100, "Difficile", "Africaine", "Dîner", 0, 0, 1, 6, "tagine_agneau"),
            listOf("Riz jollof", "Riz épicé à la tomate",
                ...
                45, "Moyen", "Africaine", "Dîner", 1, 1, 1, 6, "riz_jollof"),
        )
